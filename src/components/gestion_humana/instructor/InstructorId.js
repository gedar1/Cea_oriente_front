...
const Instructorid = () => {
  ...
  const dataValues = {
    nombres: dta?.nombres,
    apellidos: dta?.apellidos,
    documento: dta?.documento,
    tipoDocumento: dta?.tipoDocumento,
    direccion: dta?.direccion,
    telefono: dta?.telefono,
    celular: dta?.celular,
    correo: dta?.correo,
    //fecha_nacimiento: fecha_nacimiento,
    departamento: dta?.municipio?.codDepartamento?.nombreDepartamento, //aprendiz?.municipio?.codDepartamento?.nombreDepartamento,
    municipio: dta?.municipio?.nombreMunicipio, //aprendiz?.municipio?.nombreMunicipio,
    sexo: dta?.sexo,
    date: null,
    eps: dta?.eps,
    tipoInstructor: dta?.tipoInstructor,
    cajaCompensacion: dta?.cajaCompensacion,
    arl: dta?.arl,
    accept: true,
  };
  ...
  const subtitle = (
    <h4>
      {!editinst && <>{nombres}</>}
      {editar("nombres")} {!editinst && <>{apellidos}</>}
      {editar("apellidos")}{" "}
    </h4>
  );
